...
export default Tetris;`,
    ...
    "crop-studio": {
      ...
      description: "A sleek landing page for a privacy-focused photo editing tool",
...
export default function LandingPage() {
  return (
    ...
    dashboard: {
      ...
      description: "A modern dashboard with dark mode and interactive charts",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container py-8">
        ...
        <Tabs defaultValue="preview">
          ...
          <TabsContent value="preview" className="rounded-lg overflow-hidden border border-border">
